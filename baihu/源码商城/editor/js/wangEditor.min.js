...
function(a) {
        ...
        c.fn.bindEvent = function() {
            ...
            e || (e = function(c) {
                ...
                if (d && d.show){
					...
					d.show();
					if(b.dropPanel.menu.id=='insert'){insert_img(editor.txt.$txt[0].innerText);}
					} 
					return;
				}
                var e, f, g = b.editor,
    ...
    b(function(a, b) {
        ...
        a.config.menus = ['source', 'undo', 'redo', '|', 'bold', 'underline', 'eraser', 'strikethrough', 'forecolor', 'fontsize', '|', 'alignleft', 'aligncenter', 'alignright', 'table','insert', '|', 'fullscreen'],
        a.config.colors = {
            "#880000": "暗红色",
            "#800080": "紫色",
            "#ff0000": "红色",
    ...
    b(function(a, b) {
        ...
        default:
            ...
            insert: {
                normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-insert"><font  style="padding-left:3px;">插入大图</font></i></a>',
                selected: ".selected"
            },
            video: {
    ...
    b(function(a, b) {
        a.fn.addEditorContainer = function() {
            var tips=typeof(etips)!="undefined"?'<div class="wangEditor-tips" >'+etips+'</div>':'';
            this.$editorContainer = b('<div class="wangEditor-container">'+tips+'</div>')
        }
    }),
    b(function(a, b) {
    ...
    b(function(a, b) {
        ...
        a.createMenu(function(c) {
            ...
            if (c(d)) {
                ...
                $(".insert .pic div:not(.not)").live("click",function(){
                $(this).toggleClass("cur");
                }),
				$('.insert #no,.insert #go_up').live("click",function(a) {
                a.preventDefault(),
                j.dropPanel.hide();
				if($(this).attr('id')=='go_up'){layer.tips('可以在这里上传图片哦！', '.btns', {tips: [1, '#78BA32']});scTop('.btns',250);}
				}),
				$(".insert .pic div.not").live("click",function(){
					layer.alert('\u003c\u0062\u003e\u8be5\u56fe\u7247\u5df2\u5bfc\u5165\uff01\u003c\u002f\u0062\u003e\u003c\u0062\u0072\u003e\u003c\u0066\u006f\u006e\u0074\u0020\u0063\u006f\u006c\u006f\u0072\u003d\u0023\u0039\u0039\u0039\u0039\u0039\u0039\u003e\u5982\u679c\u60a8\u9700\u8981\u91cd\u590d\u5bfc\u5165\u8be5\u56fe\u7247\uff0c\u003c\u0062\u0072\u003e\u53ef\u4f7f\u7528\u003c\u0066\u006f\u006e\u0074\u0020\u0063\u006f\u006c\u006f\u0072\u003d\u0023\u0066\u0066\u0030\u0030\u0030\u0030\u003e\u005b\u0069\u006d\u0067\u005d\u5e8f\u53f7\u005b\u0069\u006d\u0067\u005d\u003c\u002f\u0066\u006f\u006e\u0074\u003e\u624b\u52a8\u6dfb\u52a0\uff01\u003c\u002f\u0066\u006f\u006e\u0074\u003e',{icon:0});
				}),
                $('.insert #ok').live("click",
                function(a) {
                    var chtml='';
					$(".insert .pic div.cur").each(function(){
						chtml+=" [img]"+$(this).attr('id')+"[/img]";
					})
                    h.command(a, "insertHtml", chtml)
                }),
                j.dropPanel = new a.DropPanel(h, j, {
                    $content: "<div class='insert font12'></div>",
                    width: 510
                }),
                h.menus[d] = j
            }
