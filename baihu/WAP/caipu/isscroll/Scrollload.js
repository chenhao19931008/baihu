...
var Scrollload = function () {
    ...
    _createClass(Scrollload, [{
        ...
        value: function createBottomDom() {
            this.container.insertAdjacentHTML('beforeend', '<div class="scrollload-bottom">' + (this._options.loadingHtml || '<div class="two-balls-swing"><div class="two-balls-swing-circle"></div><div class="two-balls-swing-circle"></div></div>') + '</div>');
...
Scrollload.prototype.defaults = {
    ...
    useScrollFix: false,
    noDataHtml: '<div class="my" style="text-align: center;line-height: 1rem;">没有更多数据了</div>',
    exceptionHtml: '<div class="yc" style="text-align: center;line-height: 1rem;">出现异常</div>'
};
