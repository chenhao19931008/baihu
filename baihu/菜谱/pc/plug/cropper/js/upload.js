...
//     if (file.files && file.files[0])
//     {
//         div.innerHTML ='<img id=zige>';
//         var img = document.getElementById('zige');
//         img.onload = function(){
//             var rect = clacImgZoomParam(MAXWIDTH, MAXHEIGHT, img.offsetWidth, img.offsetHeight);
//             img.width  =  rect.width;
//             img.height =  rect.height;
...
//     if (file.files && file.files[0])
//     {
//         div.innerHTML ='<img id=zhicheng>';
//         var img = document.getElementById('zhicheng');
//         img.onload = function(){
//             var rect = clacImgZoomParam(MAXWIDTH, MAXHEIGHT, img.offsetWidth, img.offsetHeight);
//             img.width  =  rect.width;
//             img.height =  rect.height;
